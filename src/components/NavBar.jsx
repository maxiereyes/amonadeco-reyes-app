            ...
            <ul className="navbar-nav align-items-center">
              ...
              <li className="nav-item dropdown mx-1">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a className="dropdown-item" href="todos-los-productos">
                      TODOS LOS PRODUCTOS
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="almohadones">
                      ALMOHADONES
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="caminos">
                      CAMINOS DE MESA
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="espejos">
                      ESPEJOS
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="fundas-almohadones">
                      FUNDAS DE ALMOHADONES
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="manteles">
                      MANTELES
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="tapices">
                      TAPICES
                    </a>
                  </li>
                </ul>
